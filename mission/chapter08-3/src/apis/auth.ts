...
export const patchMyProfile = async (body: RequestPatchUser): Promise<ResponseMyInfo> => {
  const { data } = await axiosInstance.patch<ResponseMyInfo>('/v1/users', body);
  return data;
};
